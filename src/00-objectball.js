function gameObject() {
  ...
  function playerNumbers(teamName) {
    const game = gameObject();
    const team = teamName === game.home.teamName ? 'home' : 'away';
    const numbers = [];
  ...
  function doesLongNameStealATon() {
    ...
    return longName === playerWithLongestName();
  }
  

  console.log('numPointsScored("Mason Plumlee"): ', numPointsScored('Mason Plumlee'));
  console.log('shoeSize("Jason Terry"): ', shoeSize('Jason Terry'));
  console.log('teamColors("Brooklyn Nets"): ', teamColors('Brooklyn Nets'));
  console.log('teamNames(): ', teamNames());
  console.log('playerNumbers("away"): ', playerNumbers('away'));
  console.log('playerStats("Alan Anderson"): ', playerStats('Alan Anderson'));
